				...
				<table id='dbem-bookings-table' class='widefat post fixed'>
					<thead>
						<tr>
							...
							<th class='manage-column' scope='col'><?php _e('Action', 'dbem'); ?></th>
						</tr>
					</thead>
					<tbody>
						<?php 
...
<td><?php echo $EM_Event->output("#_12HSTARTTIME")  . " - " .  $EM_Event->output("#_12HENDTIME"); ?></td>
				...
				<?php else: ?>
					<?php _e('You do not have any bookings. Game sign ups begin September 20th at noon PST.', 'dbem'); ?>
				<?php endif; ?>
